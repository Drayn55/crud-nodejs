...
function EditProduct() {
  ...
  return (
      <div className='max-w-lg mx-auto my-10 bg-white p-8 rounded-xl shadow shadow-slate-300'>
          <form action="" className='my-10' onSubmit={EditProduct}>
              <div className="flex flex-col">
                  ...
                  <button className='w-full py-3 font-bold text-white bg-indigo-600 hover:bg-indigo-500 rounded-lg border-indigo-500 hover:shadow' type='submit'>Update</button>
              </div>
          </form>
    </div>
  )
